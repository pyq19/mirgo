...
type Settings struct {
	...
	BaseStats           map[MirClass]baseStats
...
func New() (*Settings, error) {
	...
	BaseStats := make(map[MirClass]baseStats)
	BaseStats[MirClassWarrior] = baseStats{
		HpGain:              4,
		HpGainRate:          4.5,
		MpGainRate:          0,
		BagWeightGain:       3,
	...
	BaseStats[MirClassWizard] = baseStats{
		HpGain:              15,
		HpGainRate:          1.8,
		MpGainRate:          0,
		BagWeightGain:       5,
	...
	BaseStats[MirClassTaoist] = baseStats{
		HpGain:              6,
		HpGainRate:          2.5,
		MpGainRate:          0,
		BagWeightGain:       4,
